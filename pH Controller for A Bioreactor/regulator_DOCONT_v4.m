function [ut,auxt,auxt_labels]=regulator_DOCONT_v4(i,t,x,y,u,ts,csi,o,aux)
...
% calculation of the setpoint for pH control (desired pH value)
auxt(1)=4;

% calculation of control error (difference between setpoint and estimated pH value)
e=auxt(1)-y(i,5);
